...
def number_game_likelihood(hypothesis, data):
	...
	for i in range(len(hypothesis)):
		if hypothesis[i] == 0 and data[i] == 1:
			return np.log(0)

	num_of_opts = sum(hypothesis)
	num_present = sum(data)
	log_likelihood = np.log((1/num_of_opts)**num_present)
...
hypotheses, priors = number_game_simple_init(100, 0.5, 0.5)
# print(hypotheses)
# print()
# print(priors)
data_1 = [60, 52, 57, 55]
...
# number_game_plot_predictions(hypotheses, priors, data_1)
# number_game_plot_predictions(hypotheses, priors, data_2)
# number_game_plot_predictions(hypotheses, priors, data_3)
# number_game_plot_predictions(hypotheses, priors, data_4)
# number_game_plot_predictions(hypotheses, priors, data_5)
# number_game_plot_predictions(hypotheses, priors, data_6)
number_game_plot_predictions(hypotheses, priors, data_7)